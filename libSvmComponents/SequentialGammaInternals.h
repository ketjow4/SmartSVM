...
{
class CusomKernelGenerationSequential : public geneticComponents::IPopulationGeneration<SvmCustomKernelChromosome>
{
public:
...
class CrossoverCompensationGamma
{
public:
...
//
class EducationOfTrainingSetGamma
{
public:
	virtual ~EducationOfTrainingSetGamma() = default;
...
class SupportVectorPoolGamma : public ISupportVectorSelectionGamma
{
public:
	SupportVectorPoolGamma() = default;
...
class MemeticTrainingSetAdaptationGamma
{
public:
	MemeticTrainingSetAdaptationGamma(bool isLocalMode,
		unsigned int numberOfClassExamples,
...
//}
//
//inline void MutationCustomGaussSequential::mutatePopulation(geneticComponents::Population<SvmCustomKernelChromosome>& population)
//{
//	if (population.empty())
//	{
...
//}
//
//inline void MutationCustomGaussSequential::mutateChromosome(SvmCustomKernelChromosome& chromosome)
//{
...
//}
//
//inline int MutationCustomGaussSequential::getRandomSign() const
//{
