...
{
	class MultipleGammaGeneration : public geneticComponents::IPopulationGeneration<SvmCustomKernelChromosome>
	{
	public:
		...
		void setCandGamma(double C, std::vector<double>& gamma)
		{
			m_CSingle = C;
			m_gamma = gamma;
		}
	...
	class MultipleGammaCrossoverCompensation
	{
	public:
	...
	//
	class MultipleGammaEducationOfTrainingSet
	{
	public:
		virtual ~MultipleGammaEducationOfTrainingSet() = default;
...
class MultipleGammaSupportVectorPool : public ISupportVectorSelectionGamma
{
public:
	MultipleGammaSupportVectorPool() = default;
...
private:
	...
	class MultipleGammaMemeticTrainingSetAdaptation
	{
	public:
		MultipleGammaMemeticTrainingSetAdaptation(bool isLocalMode,
			unsigned int numberOfClassExamples,
